...
$(function(){
	...
	$.getJSON("/bishe/news/mainnewsList",function(data){
		...
		op+="<label><a href=/bishe/news/newsDisplay?newsno="+item.newsno+">"+item.newstitle+"-----"+item.newsdate+"</a></label><br/>"
		});
		$("#news1").append(op);
	});
});
...
<table class="bordered" border="1" width="300px">
	<tr>
	<thead>
		<h2>教师列表</h2>
	</thead>
	...
	<c:forEach items="${teachers}" var="teacher">
		<tr>
			<td><a href="teacherDisplay?teachno=${teacher.teachno}">${teacher.teachname}</a>
			</td>
		</tr>
	</c:forEach>
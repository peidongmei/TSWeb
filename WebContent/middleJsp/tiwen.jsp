...
<link rel="stylesheet" href="/bishe/css/tiwen.css" />
</head>
<!-- 答疑的主界面 -->
<body>
	...
	<div class="page">
		...
		<div class="dqzt">
			<label class="wz" style="float: left;">当前位置:在线答疑</label>
		</div>
		<div class="content">
			<div class="left">
				<div class="left1">
					<label
						style="font-size: 20px; font-family: '微软雅黑'; font-weight: 600px;">在线答疑</label>
					<ul>
						<li><a href="/bishe/studentLogin.jsp">->登录</a></li>
						<li><a href="/bishe/middleJsp/tiwen1.jsp">->提问</a></li>
						<li><a href="/bishe/answer/queryAnswer2">->已解决</a></li>
			...
			<div class="right">
				<%-- 					<%@ include file="/smallJsp/studentUpquestion.jsp" %>
 --%>
			</div>
		</div>
		<div class="foot">
